        ...
        <div className="recharge">
            <div className="recharge-modal">
                <form className="form-group">
                    ...
                    <input type="number" name="money" step="10000" className="form-control" value={money}
                ...
                <div>
                    <div>
                        <button type="submit" onClick={(e) => vnpayPayment(e)} className="btn btn-success">Thanh toán VNPAY</button>
                        <div className="recharge-payImg">
